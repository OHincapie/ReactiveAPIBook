package com.prgramacion.reactiva.workshop.controller;

import com.prgramacion.reactiva.workshop.model.Book;
import com.prgramacion.reactiva.workshop.service.BookService;
...
public class BookController {
    ...
    public Flux<Book> getAllBookBackPresure(@PathVariable int nro){
        return bookService.getAllBooksBackPresure(nro);
    }
